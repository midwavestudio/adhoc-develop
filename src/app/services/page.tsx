...
const services = [
  ...
  },
  {
    ...
    icon: Shovel,
    image: "/images/DJI_0013biig (1).PNG",
    features: [
    ...
    <>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  ...
                  <div className={`${index % 2 === 0 ? 'order-2 lg:order-1' : 'order-2'}`}>
                    <div className="h-[450px] flex flex-col justify-between py-6 px-1">
                      ...
                      <div className="mt-6">
                        <Button asChild className="bg-[#eaccb4] hover:bg-[#d8b99e] text-stone-800 border-none flex justify-center items-center w-full sm:w-auto">
                          <Link href="/contact">
      ...
      <section className="relative py-16 md:py-20 bg-stone-950 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <Button asChild size="lg" className="bg-[#eaccb4] text-stone-800 hover:bg-[#d8b99e] font-medium px-8 py-6 flex justify-center items-center">
            <Link href="/contact">
              Contact Us Today
            </Link>
          </Button>
