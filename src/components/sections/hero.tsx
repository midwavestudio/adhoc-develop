...
export function Hero() {
  ...
  // Reduce effect strength on mobile for better performance
      ...
      <div className="container relative z-20 mx-auto px-4 h-full flex flex-col justify-center pt-20">
        ...
        >
          ...
          >
            <Link 
              href="/services"
              className="bg-[#eaccb4] text-stone-800 hover:bg-[#d8b99e] font-medium text-lg px-8 py-4 rounded-lg text-center sm:text-left flex justify-center items-center"
            >
              Explore Our Services
            </Link>
            <Link 
              href="/contact"
              className="bg-transparent border border-[#eaccb4] text-[#eaccb4] hover:bg-[#eaccb4]/10 font-medium text-lg px-8 py-4 rounded-lg text-center sm:text-left flex justify-center items-center"
            >
              Contact Us
            </Link>
          </motion.div>
