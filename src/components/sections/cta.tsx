      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button 
            asChild
            size="lg" 
            className="bg-[#eaccb4] text-stone-800 hover:bg-[#d8b99e] font-medium text-lg px-10 py-4 flex justify-center items-center"
          >
            <Link href="/contact">
              Contact Us Today
          ...
          {/* 
          Button temporarily removed until we have projects to showcase
          <Button 
            asChild
            variant="outline" 
            size="lg" 
            className="bg-transparent border-stone-300 text-stone-100 hover:bg-stone-800/50 font-medium text-lg px-10 py-4 flex justify-center items-center"
          >
            <Link href="/projects">
              View Our Work
            </Link>
